                ...
                <div className="lobby-game-section">
                    <div className="lobby-table">
                        <div className="lobby-slot slot-leader">
                            ...
                            <img
                                src={role === 'guest' ? (friends.find(f => f.username === leaderNameUrl)?.avatarUrl || `${ApiUrl}/uploads/cosmetics/avatar.png`) : (user.avatar || user.avatarUrl || `${ApiUrl}:8080/uploads/cosmetics/avatar.png`)}
                                alt="Líder"
                        ...
                        >
                            {!player2 ? (
                                ...
                                <div className="slot-filled-content">
                                    ...
                                    <img
                                        src={role === 'guest' ? (user.avatar || user.avatarUrl || `${ApiUrl}/uploads/cosmetics/avatar.png`) : (player2?.avatarUrl || `${ApiUrl}/uploads/cosmetics/avatar.png`)}
                                        alt="Jugador 2"
                                        className="slot-portrait"
                                    />
                            ...
                            {friends.length === 0 ? (
                                ...
                                friends.map((friend) => (
                                    ...
                                    >
                                        ...
                                        <img src={friend.avatarUrl || `${ApiUrl}/uploads/cosmetics/avatar.png`} alt="Avatar" className="friend-drag-img" />
